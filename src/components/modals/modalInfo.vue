...
<template>
    <div class="modal-wrapper">
        <p class="sub__title-modal">
            Если игра открылась из Telegram, лучше перейди в браузер — это даёт +1000 к твоей удаче.
        </p>
...
.modal-wrapper {
    ...
    border-radius: 24px;
    width: 85%;
    padding-right: calc(var(--app-height)* 3.9 / 100);
    padding-left: calc(var(--app-height)* 3.9 / 100);
}
