...
<template>
    <div class="modal-wrapper">
        <p class="title-modal">
            Создавать метавселенную МТС Verse, прокачивать сервис МТС Музыка или улучшать онлайн-кинотеатр KION?
        </p>
        <p class="sub__title-modal">
            В нашей экосистеме более 250 продуктов. Здесь можно выбирать проекты по душе и решать интересные задачи, которые развивают тебя, компанию и мир. Мы даём свободу творчества, приветствуем новые идеи и ценим вклад каждого.
        </p>
        <ButtonMts  @click="next" class="btn" text="УРОВЕНЬ #2">
        </ButtonMts>
    </div>
