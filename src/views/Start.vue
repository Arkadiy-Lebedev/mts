...
<template>
    <section class="start">
        ...
        <div class="start-content">
            ...
            <p class="sub__title">
                Мы создаём технологии, которые делают жизнь комфортнее. Здесь ждут амбициозные задачи, разнообразие карьерных треков и возможность менять привычное к лучшему. Узнай больше о компании и преимуществах работы в МТС.
            </p>
